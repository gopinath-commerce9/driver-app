...
import { OrderDeliveryPageService } from './../../services/order-delivery-page.service';
...
export class OrderDeliveryPage implements OnInit {
  ...
  constructor(
    ...
    private service: OrderDeliveryPageService
  ) {
    console.log('OrderDeliveryPage constructor');
    this.appTitle = appConfigs.appMainTitle;
    this.pageTitle = 'Delivery Order Details';
  }

  ngOnInit() {
    console.log('OrderDeliveryPage ngOnInit');
  ...
  ionViewWillEnter() {
    console.log('OrderDeliveryPage ionViewWillEnter');
  }

  ionViewDidEnter() {
    console.log('OrderDeliveryPage ionViewDidEnter');
  }

  ionViewWillLeave() {
    console.log('OrderDeliveryPage ionViewWillLeave');
  }
